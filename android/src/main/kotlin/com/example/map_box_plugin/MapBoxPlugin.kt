...
import com.example.map_box_plugin.activity.NavigationLauncher
import com.example.map_box_plugin.factory.EmbeddedNavigationViewFactory
...
/** MapBoxPlugin */
class MapBoxPlugin: FlutterPlugin, MethodCallHandler,
  ...
  override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    ...
    channel = MethodChannel(messenger, "map_box_plugin")
    channel.setMethodCallHandler(this)

    progressEventChannel = EventChannel(messenger, "map_box_plugin/events")
