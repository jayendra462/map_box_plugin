package com.example.map_box_plugin.activity
...
import com.example.map_box_plugin.MapBoxPlugin
import com.example.map_box_plugin.R
import com.example.map_box_plugin.databinding.NavigationActivityBinding
import com.example.map_box_plugin.models.MapBoxEvents
import com.example.map_box_plugin.models.MapBoxRouteProgressEvent
import com.example.map_box_plugin.models.Waypoint
import com.example.map_box_plugin.models.WaypointSet
import com.example.map_box_plugin.utilities.CustomInfoPanelEndNavButtonBinder
import com.example.map_box_plugin.utilities.PluginUtilities
import com.example.map_box_plugin.utilities.PluginUtilities.Companion.sendEvent
...
class NavigationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (MapBoxPlugin.longPressDestinationEnabled) {
        ...
        if (MapBoxPlugin.enableOnMapTapCallback) {
            binding.navigationView.registerMapObserver(onMapClick)
        }
        val act = this
        ...
        var styleUrlDay = MapBoxPlugin.mapStyleUrlDay
        var styleUrlNight = MapBoxPlugin.mapStyleUrlNight
        ...
        if (MapBoxPlugin.enableFreeDriveMode) {
            binding.navigationView.api.routeReplayEnabled(MapBoxPlugin.simulateRoute)
    ...
    private fun requestRoutes(waypointSet: WaypointSet) {
        ...
        MapboxNavigationApp.current()!!.requestRoutes(
            routeOptions = RouteOptions
                ...
                .language(MapBoxPlugin.navigationLanguage)
                .alternatives(MapBoxPlugin.showAlternateRoutes)
                .voiceUnits(MapBoxPlugin.navigationVoiceUnits)
                .bannerInstructions(MapBoxPlugin.bannerInstructionsEnabled)
                .voiceInstructions(MapBoxPlugin.voiceInstructionsEnabled)
                .steps(true)
                .build(),
...
//        }
    ...
    private val routeProgressObserver = RouteProgressObserver { routeProgress ->
        ...
        MapBoxPlugin.distanceRemaining = routeProgress.distanceRemaining
        MapBoxPlugin.durationRemaining = routeProgress.durationRemaining
