...
public class FlutterMapboxNavigationView : NavigationFactory, FlutterPlatformView
{
    ...
    init(messenger: FlutterBinaryMessenger, frame: CGRect, viewId: Int64, args: Any?)
    {
        ...
        self.channel = FlutterMethodChannel(name: "map_box_plugin/\(viewId)", binaryMessenger: messenger)
        self.eventChannel = FlutterEventChannel(name: "map_box_plugin/\(viewId)/events", binaryMessenger: messenger)
