...
public class MapBoxPlugin :NavigationFactory, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "map_box_plugin", binaryMessenger: registrar.messenger())
     let eventChannel = FlutterEventChannel(name: "map_box_plugin/events", binaryMessenger: registrar.messenger())
    let instance = MapBoxPlugin()
