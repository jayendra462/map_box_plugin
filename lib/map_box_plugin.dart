...
import 'map_box_plugin_platform_interface.dart';

class MapBoxPlugin {
  static final MapBoxPlugin _instance = MapBoxPlugin();
  static MapBoxPlugin get instance => _instance;
  ...
  Future<String?> getPlatformVersion() {
    return MapBoxPluginPlatform.instance.getPlatformVersion();
  }

  ///Total distance remaining in meters along route.
  Future<double?> getDistanceRemaining() {
    return MapBoxPluginPlatform.instance.getDistanceRemaining();
  }

  ///Total seconds remaining on all legs.
  Future<double?> getDurationRemaining() {
    return MapBoxPluginPlatform.instance.getDurationRemaining();
  }
  ...
  Future<dynamic> addWayPoints({required List<WayPoint> wayPoints}) async {
    return MapBoxPluginPlatform.instance.addWayPoints(wayPoints: wayPoints);
  }
  ...
  Future<bool?> startFreeDrive({MapBoxOptions? options}) async {
    ...
    return MapBoxPluginPlatform.instance.startFreeDrive(options);
  }
  ...
  Future<bool?> startNavigation({
    ...
    options ??= _defaultOptions;
    return MapBoxPluginPlatform.instance.startNavigation(wayPoints, options);
  }

  ///Ends Navigation and Closes the Navigation View
  Future<bool?> finishNavigation() async {
    return MapBoxPluginPlatform.instance.finishNavigation();
  }

  /// Will download the navigation engine and the user's region
  /// to allow offline routing
  Future<bool?> enableOfflineRouting() async {
    return MapBoxPluginPlatform.instance.enableOfflineRouting();
  }
  ...
  Future<dynamic> registerRouteEventListener(
    ...
    return MapBoxPluginPlatform.instance.registerRouteEventListener(listener);
  }
}
