...
/// An implementation of [MapBoxPluginPlatform] that uses method channels.
class MethodChannelMapBoxPlugin extends MapBoxPluginPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('map_box_plugin');

  @visibleForTesting
  final eventChannel = const EventChannel('map_box_plugin/events');
